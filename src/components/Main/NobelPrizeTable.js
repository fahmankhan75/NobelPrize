...
const headCells = [
  { id: 'name', numeric: true,  label: 'Year' },
  { id: 'calories', numeric: false, label: 'Category' },
  { id: 'fat', numeric: false, label: 'First Name' },
  { id: 'carbs', numeric: false,  label: 'Last Name' },
  { id: 'protein', numeric: false,  label: 'Motivation' },
];
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography className={classes.title} variant="h5" id="tableTitle" component="div">
          Nobel Prize Information Directory
        </Typography>
      )}
